...
function App() {
  return (
    <div className="font-sans bg-brand-dark text-brand-text selection:bg-emerald-500/30 selection:text-emerald-200">
      ...
      <Section className="bg-brand-dark">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={i} className="bg-brand-card p-6 rounded-xl border border-slate-800 hover:border-emerald-500/30 transition-all group">
        ...
        <div className="mt-20 max-w-4xl mx-auto text-center relative px-6">
        ...
        <div className="flex justify-center mt-12">
            <Button variant="secondary" className="text-sm py-2 px-6">Sim, quero resolver isso agora</Button>
        </div>
      </Section>
      ...
      {/* 9. Deliverables */}
      <Section className="bg-brand-dark">
         <div className="bg-gradient-to-b from-brand-card to-brand-dark p-8 md:p-12 rounded-3xl border border-slate-800 text-center">
      ...
      <Section className="bg-[#0B1221]">
        ...
        <div className="flex justify-center mt-12">
            <Button variant="secondary" className="text-sm">Sim, quero resolver isso agora</Button>
        </div>
      </Section>
